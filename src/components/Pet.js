    ...
    return(
            <div className='container px-5'>
                ...
                <div className='container-fluid'>
                    ...
                    <a href='/add-item'><button type="button" class="btn btn-success px-4">Add to List</button></a>
                        </div>

                </div>
                <div className="accordion px-5" id="accordionExample">
                    <div className="accordion-item text-end">
                        <span className="badge text-bg-success rounded-pill mx-2">14</span>
                    ...
                    <div className="accordion-item text-end">
                        <span className="badge text-bg-success rounded-pill mx-2">2</span>
                    ...
                    <div className="accordion-item text-end">
                        <span className="badge text-bg-success rounded-pill mx-2">1</span>
